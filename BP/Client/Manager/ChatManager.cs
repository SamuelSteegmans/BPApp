...
namespace BP.Client.Manager
{
    public class ChatManager : IChatManager
    {
        ...
        public async Task<List<ApplicationUser>> GetLikedUsersAsync()
        {
            var data = await _httpClient.GetFromJsonAsync<List<ApplicationUser>>("api/profile/likedusers");
            return data;
        }

        public async Task<List<ApplicationUser>> GetUserContactsAsync()
        {
            var data = await _httpClient.GetFromJsonAsync<List<ApplicationUser>>("api/chat/usercontacts");
            return data;
        }
